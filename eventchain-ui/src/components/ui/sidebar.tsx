      ...
      return (
        ...
        >
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden touch-manipulation z-50"
            style={
              {
            ...
            side={side}
          >
            <div className="flex h-full w-full flex-col touch-manipulation">{children}</div>
          </SheetContent>
        </Sheet>
      );
    }
